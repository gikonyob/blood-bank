...
$t=mysqli_query($MySQLi_CON,"select * from contactus ORDER BY id DESC");
...
$query=mysqli_query($MySQLi_CON,"select * from contactus ORDER BY id DESC limit $start,$limit");
?>
            ...
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
					...
					<li class="nav-item"><a class="nav-link link" href="account">ACCOUNT</a></li>
					  <li class="nav-item"><a class="nav-link link" href="../contactus">CAMPS</a></li>
...
<th>Message</th>
    ...
    <?php
    $res = $MySQLi_CON->query("SELECT * FROM contactus ORDER BY id DESC");
    $count = $res->num_rows;
    if($count > 0) {
...
if($count > 0)
{
    ...
    <span><img src="delete.png" onclick="delete_contactus();"  alt="delete" />&nbsp;</span>
    </label>
...
<a href="../user/viewrequests" class="text-white">View Requests</a><br><a href="../contactus" class="text-white">Camps</a><br><a href="../about" class="text-white">About</a><br><a href="../contact" class="text-white">Contact us</a><p><p></p>
